...
class AllPetPage extends ConsumerStatefulWidget {
  final Function? function;

  AllPetPage({this.function});

  @override
  _AllPetPage createState() => _AllPetPage();
}

class _AllPetPage extends ConsumerState<AllPetPage> {
  @override
  ...
  Widget sellerList(List<Pet> pets) {
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: getCustomTextWidget(
                                    pet.description.length > 20 ? pet.description.substring(0, 20) + '...' : pet.description,
                                    textColor,
