...
class CheckAddressPage extends ConsumerStatefulWidget {
  final Pet pet; // Ensure this is defined

  const CheckAddressPage({Key? key, required this.pet}) : super(key: key);

  @override
  _CheckAddressPage createState() => _CheckAddressPage();
}

class _CheckAddressPage extends ConsumerState<CheckAddressPage> {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => CheckOutPage(
                            ...
                            pet: widget.pet, // Truyền đối tượng pet
                          ),
                        ),
                      );
                    } else {
